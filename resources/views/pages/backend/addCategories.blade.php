...
@section('homeContent')
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form enctype="multipart/form-data" action="{{route('categories.store')}}" class="form-sample p-3"
                method="post">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        type="text" required name="meta_title" class="form-control">
                                </div>
                                ...
                                <div class="section-title" style="font-size:12px; ">Category Image
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Size Should be 715px by 400px)</div>
